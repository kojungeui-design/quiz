...
const steps = [
  ...
  },
  {
    ...
    body: `
      ...
      <h4>화면의 점수를 어떻게 읽나</h4>
      <ul>
        <li><b>비교점수</b> — 후보끼리 견주려고 만든 <u>화면용 점수</u>입니다. 성능 합격률도, 통계적 확률도 아닙니다.
            80점이 70점보다 "이 관점에서 낫다"는 뜻일 뿐입니다.</li>
        <li><b>근거점수</b> — 통계적 신뢰확률이 아니라 <u>DB 근거등급과 경고를 점수로 옮긴 참고값</u>입니다.</li>
        <li><b>근거등급 A</b>도 승인 근거가 아닙니다. DB 근거가 두터울 뿐이고, <b>승인에는 시험 검증이 필요</b>합니다.</li>
      </ul>

      <h4>적층 — 이 케이스에 들어가는가</h4>
      <p>매수 옆에 <code>기판두께합 11.36 / 14.4mm</code> 처럼 표시됩니다.
         앞은 이 설계의 <b>셀당 기판두께합</b>(양극매수×두께 + 음극매수×두께),
         뒤는 <b>그 제품군에서 실제로 만들어진 최대치</b>입니다. 넘으면 빨갛게 바뀌고 경고가 뜹니다.</p>
      <div class="warn-box"><b>이건 mm 단위 조립 계산이 아닙니다.</b> 제대로 하려면 완성극판 두께·격리판 두께·케이스
        내부 치수가 필요한데 사내 DB에 없습니다. 그래서 “치수가 맞는가”가 아니라 <b>“이만한 극판이 이 케이스에
        들어간 적이 있는가”</b>에만 답합니다. 넘었다고 불가능한 것은 아니지만, <b>전례가 없으니 확인이 필요하다</b>는 뜻입니다.</div>
      <div class="tip">활물질·격리판 두께가 빠져 있으므로 <b>같은 제품군 안에서만</b> 뜻이 있는 값입니다.
        D26의 14.4mm와 H52의 30.6mm를 견주지 마세요.</div>
      ...
      <h4>신형 극판 두께 가정 (1·2안)</h4>
      <p>1·2안의 신형 양극은 <b>0.70T Punch</b>로 계산됩니다. 그런데 이 두께는
         <b>사내 극판 마스터에 한 종도 없습니다</b>(최소 0.74T, 실제 제품 중앙값 0.90T).
         실제보다 얇게 잡으면 기판중량·납중량·원가가 낮게 나와 신형안이 유리하게 보입니다.</p>
      <div class="warn-box">그래서 설계마다 <b>“극판 마스터에 없는 두께입니다”</b> 경고가 붙습니다.
        Punch로 실제 몇 T까지 되는지 생산기술에 확인하고,
        <b>요구사양 → 원가 가정 → 신형 양극 기판두께</b>를 그 값으로 맞춰주세요.
        도구가 임의로 정하지 않습니다.</div>
