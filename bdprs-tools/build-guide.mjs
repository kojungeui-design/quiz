...
const steps = [
  ...
  },
  {
    ...
    body: `
      ...
      <table class="fields">
        ...
        <tr><td>연간 기준수량</td><td>사업계획 수량 (대)</td><td>금형 투자비를 나눠 싣는 기준</td></tr>
      </table>
  ...
  },
  {
    ...
    body: `
      ...
      <table class="plans">
        <tr><th>안</th><th>내용</th><th>개발 투자</th><th>위험</th></tr>
        <tr><td><b>1안</b> 모두 신형 극판</td><td>양·음극을 새로 설계 (양극 0.7T Punch)</td><td>가장 큼</td><td class="bad">높음</td></tr>
        <tr><td><b>2안</b> 신형 + 기존 공용</td><td>양극만 신형, 음극은 기존 것</td><td>중간</td><td class="warn">보통</td></tr>
        <tr><td><b>3안</b> 기존 극판 공용</td><td>이미 있는 극판만 조합</td><td class="good">0원</td><td class="good">낮음</td></tr>
      </table>
      <p>카드에서 볼 것은 <b>목표 충족(몇/몇)</b>, <b>가중 평균원가</b>, <b>개발 투자</b>, <b>공용화율</b> 네 가지입니다.
      ...
      <ul>
        ...
        <li><b>공용 극판군 · 개발 투자</b> — 금형비는 극판군마다 1회 들고, 그 극판군을 쓰는 물량 전체가 나눠 집니다.</li>
      </ul>
