...
const steps = [
  ...
  },
  {
    ...
    body: `
      ...
      <h4>극판 1종을 더 만들 값어치가 있나 (극판군 통합 검토)</h4>
      <p>실시간 조절 카드 아래에 <b>극판군 통합 검토</b> 표가 있습니다.
         금형비가 0이라 <u>합쳐서 아낄 돈이 없으므로</u>, 원가만 보면 극판은 많을수록 좋습니다.
         하지만 극판 종류가 늘면 부동재고 부담이 생기죠. 그 부담과 견줄 <b>연간 절감액</b>을 계산해 드립니다.</p>
      ${figure('07e-consolidation.jpg', '극판군 통합 검토', '1종 → 2종이 연 2.08억원을 아낀다면, 부동재고 부담이 그보다 작을 때 만드는 것이 맞습니다')}
      <ul>
        <li><b>아래에서 위로 읽으세요.</b> 각 줄의 「직전 대비 절감」이 <u>극판을 1종 더 만들어서 버는 돈</u>입니다.</li>
        <li>절감액은 극판군이 늘수록 줄어듭니다. <b>꺾이는 지점</b>이 판단 지점입니다.</li>
        <li><b>목표 충족</b>이 같은 줄에 있습니다. 원가가 싸져도 목표를 놓치면 대안이 아닙니다.</li>
        <li>요구사양의 <b>극판 1종당 부동재고 부담</b>에 금액을 넣으면 어디까지가 유리한지 표시해 드립니다.
            넣지 않으면 절감액만 보여드립니다 — 그 금액은 도구가 알 수 없기 때문입니다.</li>
        <li>통합 범위는 <b>그 제품군 실적에 등록된 극판</b>뿐입니다. 제품군을 넘는 강제 공용은 하지 않습니다.</li>
      </ul>
